      ...
      <div className="flex flex-col relative mb-5">
        <div className="flex items-center">
          <button
            ...
            className={
              editIsClicked ? "flex md:hidden mr-3 " : "md:hidden mr-3"
            }
          >
            <EditMobileComponent
              className="w-6 h-6 "
          ...
          <AnimatePresence>
            {editIsClicked && (
              <motion.div
                ...
                className="md:hidden absolute gap-2 top-0 bottom-0 right-0 left-[36px] z-10 bg-foreground/90
                rounded-xl backdrop-blur-3xl flex items-center justify-around p-2"
              >
                <button
                ...
                >
                  <DiceComponent
                    className="min-w-4 min-h-4 max-w-5 max-h-5"
                    color="fill-background"
                    title="Random Answer"
                  />
        ...
        <div
          className="-mt-2 ml-4 self-start bg-background border-textinput-field-border border-2 rounded-lg h-3 overflow-hidden w-16
         hover:w-[90%] hover:h-7 transition-all duration-200 hover:bg-choice-bg/80 
         items-center hidden md:flex hover:[&>*]:opacity-100 [&>*]:opacity-0"
        >
